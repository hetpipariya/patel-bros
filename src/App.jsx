...
const CUSTOM_GALLERY_IMAGE_URLS = {
  WEDDINGS: [
    'https://imgs.search.brave.com/uWdNZskUd6nu9oz1BSMh4zpkqPJNQftDtc8j-Z5oWTU/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pMC53/cC5jb20vZGVjb3Jz/dXRyYWJsb2cuY29t/L3dwLWNvbnRlbnQv/dXBsb2Fkcy8yMDIw/LzA0L2Nvcm9uYXZp/cnVzLWxvY2tkb3du/LWluZGlhbi13ZWRk/aW5nLXRoZW1lMy5q/cGc_cmVzaXplPTc4/MCw5NzUmc3NsPTE', 
    'https://imgs.search.brave.com/-GlSYdHtyt3-Na3zZkKV27oPOadBcUMj8AfhkiRewF4/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pLnBp/bmltZy5jb20vb3Jp/Z2luYWxzLzJiLzk2/LzNiLzJiOTYzYjEx/YTdkZTEyZjg0YWZk/ODUzYzg3YzE5ODhl/LmpwZw', 
    'https://imgs.search.brave.com/p5y3acaXQ9oLXS2i8GJV9eGTm1o2HhLMUwu3vrgcud8/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly90My5m/dGNkbi5uZXQvanBn/LzE2LzI4LzIxLzkw/LzM2MF9GXzE2Mjgy/MTkwMjBfUW5lYzNR/YlVHRDR4SjJBY3Y0/aHhMVFVmTDhNWndw/SEouanBn', 
    'https://imgs.search.brave.com/SZF8eYaaxDaojZlxOsaqqEyiAGvY0hZMuUVgU04JKtA/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9nZXRl/dGhuaWMuY29tL3dw/LWNvbnRlbnQvdXBs/b2Fkcy8yMDIwLzA5/LzIxOTQxNy1BbmNo/YWxBbmRQQXJhZ1dl/ZGRpbmctMTQyMi1v/cmlnLmpwZw', 
    'https://imgs.search.brave.com/1NEn9vodn67qv7nRP-UBwHQrtJTIYe-kWb2bCbze9gw/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pLnBp/bmltZy5jb20vb3Jp/Z2luYWxzL2MwL2Nl/Lzg5L2MwY2U4OTlj/NGMxOWE0MDQwOTE3/OWRmMTAxOTM3MWVm/LmpwZw', 
    ...
    'https://media.istockphoto.com/id/806985520/photo/naranarayan-setu.jpg?s=612x612&w=0&k=20&c=SzT3QFPd3j_HcnDfnFjwLfuR_4_3GFEf1jIykIuimEw=',
  ...
  OTHER: [
    ...
    'https://imgs.search.brave.com/NytcXMX7gts_WVw7FnweQVAFv-xb7JGS0RHrUqQ2iqs/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pbWFn/ZXMucGV4ZWxzLmNv/bS9waG90b3JlYWxpc3Rp/Yy13ZWRkaW5nLXZl/bnVlLXdpdGgtaW50/cmljYXRlLWRlY29y/LW9ybmFtZW50c18y/My0yMTUxNDgxNDY4/LmpwZz9zZW10PWFp/c19oeWJyaWQmdz03/NDAmcT04MA',
...
const LOCATION_IMAGES = {
  ...
  "Konark": "https://imgs.search.brave.com/H2QgmxxCrXo5LPRbh9quU6rqfmTD4rjOMLB2SrBSZPg/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9vbmVk/YXkudHJhdmVsL3dw/LWNvbnRlbnQvdXBs/b2Fkcy8vMjAyMy8w/OC9rb25hcmstc3Vu/LXRlbXBsZS5qcGc",
    ...
    <nav className={`fixed top-0 inset-x-0 z-50 transition-all duration-500 ${scrolled ? 'bg-[#050A18]/90 border-b border-[#D4AF37]/20 backdrop-blur-md py-4' : 'bg-transparent py-6'}`}>
      <div className="w-full px-6 md:px-12 flex items-center justify-between">
        ...
        <div onClick={() => navigate('/')} className="flex items-center gap-4 group cursor-pointer z-50">
           {/* Logo Image: Ensure logo.jpg is in your public folder */}
